...
def synchronize_sign(files_info: Iterable[SynchronizeModelFilesInfo], callback: Callback | None = None) -> None:
    ...
    for info in files_info:
        existing_file_paths = get_existing_paths(info.model._meta.get_field(info.file_field_name))  # noqa
        existing_sign_paths = get_existing_paths(info.model._meta.get_field(info.sign_field_name))  # noqa
